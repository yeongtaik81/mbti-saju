...
function buildCategoryBase(option: ScenarioOption): ScenarioOverlay {
  switch (option.categoryCode) {
    ...
    case 'COMPAT_OVERVIEW':
      return {
        titleLabel: option.label,
        narrativeAddon: `이번 궁합은 '${option.label}'을 기준으로 두 사람 전체 흐름을 넓게 읽습니다. ${option.description}`,
        subjectLensAddon:
          '이 궁합은 누가 더 맞는지 단정하기보다, 함께 있을 때 편안해지는 장면과 자주 어긋나는 기준을 나눠 보는 편이 정확합니다.',
        timingAddon:
          '기본 궁합은 감정이 격한 날보다, 두 사람의 생활 리듬을 몇 번 지켜본 뒤 읽을수록 훨씬 선명해집니다.',
        cautionAddon:
          '잘 맞는다는 말만 믿고 중요한 생활 기준을 생략하면, 좋은 궁합도 현실에서는 쉽게 지칠 수 있습니다.'
      };
    case 'COMPAT_ROMANCE':
      return {
        titleLabel: option.label,
...
> = {
  ...
  SELF_CAREER_APTITUDE: {
    ...
    actionOverride:
      '반복할수록 에너지가 남는 일 1개와 금방 닳는 일 1개를 따로 적어 보기'
  },
  SELF_CAREER_GENERAL: {
    narrativeAddon:
  ...
  COMPAT_ROMANCE_LOVER: {
    narrativeAddon:
      '이번 궁합은 이미 만나고 있는 두 사람이 왜 편안한지, 혹은 왜 자꾸 같은 곳에서 닳는지를 중심으로 읽습니다.',
    compatibilityLensAddon:
      '현재 연인 궁합은 사랑의 크기보다 다툰 뒤에도 관계가 다시 안심되는 구조가 있는지를 보는 편이 정확합니다.',
    pairDynamicText:
      '이 관계는 애정이 분명한 대신, 기대하는 가까움과 회복 속도가 다르면 같은 문제를 반복하기 쉬운 타입입니다. 잘 맞을 때는 안정감이 크게 붙지만, 서운함을 오래 미루면 마음의 온도 차이가 금방 커질 수 있습니다.',
    attractionPointText:
      '지금도 관계가 이어지는 이유는 서로에게 익숙함과 애정이 동시에 남아 있기 때문입니다. 상대가 내 일상을 알고 있다는 안정감이 이 관계의 큰 장점으로 작동할 수 있습니다.',
    conflictTriggerText:
      '좋아하니까 이해해 줄 거라는 기대가 커지면 생활 리듬 차이와 표현 방식 차이가 서운함으로 쌓이기 쉽습니다. 문제의 크기보다 회복을 늦추는 태도가 더 크게 피로를 만들 수 있습니다.',
    communicationText:
      '현재 연인 관계에서는 감정 확인을 반복하기보다, 서운했던 장면을 생활 문장으로 바꿔 말하는 편이 더 효과적입니다. “왜 그랬어?”보다 “이럴 때 나는 이렇게 느껴”처럼 짧고 분명한 말이 잘 맞습니다.',
    actionOverride:
      '지금 관계를 더 편안하게 만들 생활 기준 1개와 자주 서운한 지점 1개를 나눠 적어 보기'
  },
  COMPAT_ROMANCE_MARRIAGE_PARTNER: {
    narrativeAddon:
      '이번 궁합은 결혼 자체의 성사보다, 오래 함께 살 때 무엇이 편안하고 무엇이 반복 피로가 되는지를 중심으로 읽습니다.',
    compatibilityLensAddon:
      '결혼 상대 궁합은 설렘보다 생활 감각, 돈 기준, 가족 역할을 함께 다룰 수 있는지를 먼저 보는 편이 정확합니다.',
    pairDynamicText:
      '이 관계는 마음이 통해도 생활 기준이 다르면 가까워질수록 피로가 선명해질 수 있는 타입입니다. 반대로 중요한 기준이 이미 비슷하다면 설렘보다 안심감이 더 크게 자라기 쉬운 관계이기도 합니다.',
    attractionPointText:
      '오래 보고 싶다는 마음이 드는 이유는 감정뿐 아니라 함께 있을 때 기본 리듬이 덜 무너지기 때문일 가능성이 큽니다. 편안함과 책임감이 같이 느껴지는 점이 이 관계의 핵심 매력입니다.',
    conflictTriggerText:
      '좋아하는 마음만으로 결혼 이야기를 서두르면 돈, 시간, 가족 역할 같은 현실 기준이 뒤늦게 큰 충돌로 올라올 수 있습니다. 모호한 기대가 가장 큰 피로를 만드는 관계입니다.',
    communicationText:
      '이 관계는 미래를 크게 약속하는 말보다 생활 기준을 짧은 문장으로 맞춰 보는 대화가 더 중요합니다. “우리 잘 맞을까?”보다 “돈, 시간, 가족 문제를 나는 이렇게 생각해”처럼 구체적인 문장이 잘 맞습니다.',
    actionOverride:
      '결혼을 생각할 때 꼭 맞아야 할 생활 기준 2개와 미리 확인할 질문 1개를 적어 보기'
  },
  COMPAT_ROMANCE_MARRIED: {
    narrativeAddon:
      '이번 궁합은 부부 사이의 사랑만이 아니라, 같이 사는 속도와 애정 표현, 집안일과 돈의 기준이 어떻게 관계의 온도를 바꾸는지를 함께 읽습니다.',
    compatibilityLensAddon:
      '부부 궁합은 감정만이 아니라 생활 장면과 서운함을 푸는 방식을 같이 읽어야 실제 피로와 회복 포인트가 분명하게 보입니다.',
    pairDynamicText:
      '이 관계는 같이 사는 속도와 회복 방식이 맞을수록 애정과 현실을 함께 오래 끌고 갈 수 있는 타입입니다. 서로를 잘 안다는 장점이 크지만, 피로한 날의 말투와 생활 기준 차이가 말없이 쌓이면 같은 문제로 자주 닳을 수 있습니다.',
    attractionPointText:
      '부부로 계속 붙어 있는 힘은 큰 이벤트보다 일상에서 생기는 익숙한 안심감에 있습니다. 서로의 약한 날을 감당해 본 기억이 관계를 쉽게 놓지 않게 만드는 장점으로 작동합니다.',
    conflictTriggerText:
      '피곤한 날의 말투나 집안일·돈의 서운함을 성격 문제로 받아들이기 시작하면 감정 상처가 오래 남기 쉽습니다. 가까운 관계일수록 반복되는 작은 불편이 더 큰 갈등으로 번질 수 있습니다.',
    communicationText:
      '부부 관계에서는 감정 싸움이 커진 뒤 해석하기보다 서운한 지점 1개와 바라는 방식 1개를 짧게 나누는 대화가 더 중요합니다. “왜 늘 그래?”보다 “이 부분은 이렇게 맞추고 싶어”처럼 집안일·돈·휴식 기준을 가볍게 다시 맞추는 말이 더 잘 맞습니다.',
    actionOverride:
      '부부로 살며 자주 부딪히는 생활 장면 1개와 다시 맞추고 싶은 기준 1개를 적어 보기'
  },
  COMPAT_ROMANCE_EX: {
    narrativeAddon:
    ...
    actionOverride:
      '다시 만나도 달라져야 할 점 1개와 그대로면 안 되는 점 1개를 나눠 적어 보기'
  },
  COMPAT_ROMANCE_BLIND_DATE: {
    ...
    actionOverride:
      '한 번 더 보고 싶은 이유 1개와 망설이는 이유 1개를 따로 적어 보기'
  },
  COMPAT_ROMANCE_FRIEND_TO_LOVER: {
    ...
    actionOverride:
      '친구로 남기고 싶은 지점 1개와 연인으로 바라는 지점 1개를 나눠 적어 보기'
  },
  ...
  COMPAT_ROMANCE_LEFT_ON_READ: {
    ...
    actionOverride: '답장 속도 대신 관계 온도를 판단할 기준 1개를 먼저 정하기'
  },
  COMPAT_FRIEND_CUT_OFF: {
    ...
    actionOverride:
      '지금 지키고 싶은 관계의 선 1개를 문장으로 적고 바로 적용해 보기'
  },
  COMPAT_FRIEND_TRAVEL: {
    ...
    actionOverride:
      '여행 전에 꼭 정할 기준 2개와 현장에서 정할 것 1개를 나눠 적기'
  },
  COMPAT_ROMANCE_FLIRTING: {
    ...
    actionOverride:
      '이 썸을 더 끌고 갈지 지켜볼지 지금의 마음을 한 문장으로 먼저 정리하기'
  },
  COMPAT_FRIEND_BEST: {
    narrativeAddon:
    ...
    actionOverride: '오래 묵힌 서운함 1개를 짧게 말할 문장으로 바꿔 보기'
  },
  COMPAT_WORK_COWORKER: {
    ...
    actionOverride: '중간 공유 시점 1개와 완료 기준 1개를 먼저 문장으로 맞추기'
  },
  COMPAT_FRIEND_ROOMMATE: {
    ...
    actionOverride:
      '청소, 손님, 취침 중 가장 먼저 맞춰야 할 생활 기준 1개를 정하기'
  },
  COMPAT_ROMANCE_CRUSH: {
    ...
    actionOverride:
      '상대에 대한 사실 3개와 내가 덧붙인 해석 3개를 따로 적어 보기'
  },
  COMPAT_WORK_DIFFICULT_BOSS: {
    ...
    actionOverride:
      '애매한 요청을 받았을 때 바로 되물을 기준 문장 1개를 만들어 두기'
  },
  COMPAT_WORK_BOSS: {
    narrativeAddon:
    ...
    actionOverride:
      '상사가 안심하는 보고 기준 1개를 오늘 바로 문장으로 정리하기'
  },
  COMPAT_WORK_BUSINESS_PARTNER: {
    ...
    communicationText:
      '좋은 합일수록 중요한 건 말보다 남는 약속입니다. 돈, 역할, 철수 기준을 먼저 적어 두면 관계와 일 둘 다 더 오래 갑니다. 편한 사이일수록 나중에 딴말이 나오지 않게 합의 내용을 글로 남겨 두는 편이 안전합니다.',
    actionOverride: '권한, 수익 배분, 철수 기준을 한 문장씩 적어 초안 만들기'
  },
  ...
  COMPAT_FAMILY_MOTHER_DAUGHTER: {
    ...
    actionOverride:
      '엄마에게 꼭 말하고 싶은 선 1개를 탓 없는 문장으로 다시 적어 보기'
  },
  COMPAT_FAMILY_PARENT_CHILD: {
    ...
    actionOverride:
      '걱정, 기대, 부담 중 지금 가장 큰 감정 1개를 골라 말로 바꿔 보기'
  },
  COMPAT_FAMILY_MOTHER_IN_LAW: {
    ...
    actionOverride:
      '예의를 지키면서도 분명히 말할 선 1개를 미리 문장으로 적어 두기'
  },
  COMPAT_MISC_IDOL: {
    narrativeAddon:
    ...
    actionOverride: '닮고 싶은 점 1개를 현실 루틴으로 옮길 행동 1개로 바꿔 적기'
  }
};
